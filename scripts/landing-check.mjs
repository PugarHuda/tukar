// Landing-page QA (Playwright real-click). The landing is what a judge sees first,
// so this asserts it loads clean, its on-chain links point to the LIVE contracts,
// its footer links deep-link to the named doc/circuit (not just the repo root), and
// the primary CTA actually lands you in the working demo.
//
//   node scripts/landing-check.mjs [baseUrl]   (default https://tukar-six.vercel.app)
...
const LIVE = new Set([
  "CABRLZHDU4JVMZ6LEF7RLN3VN5ZXGGI54LGB54QZSLTDMPM2AA7FEXPJ", // pool
  "CCRCRVFVKK3RCPB5OVYBZL2YC6WD2EHGEQXMNU2AZ6OS4OUZMFQI6K3N", // transfer
  "CAGBZGFMWGUIQ5EMA5QEIFKHUQ543V6IP4TB6P2T26PMEZFBX7FXIJQO", // compliance
  "CACVDX243MADPXZ6C5DPVH65BHNY2D6MR2357JLP4XUYCHY2EHIAAOD3", // disclosure
  "CBQB4AJ4HU3YVFE2DCNUSBXH3WJD5IFR6NMOH42RQM3HZDO5TBM7EP5Z", // merkleUpdate
]);
