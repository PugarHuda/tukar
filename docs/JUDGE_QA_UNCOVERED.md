...
tests and 333 Cargo tests live on testnet, which is the strongest evidence in the room.
...
rounds against a documented threat model, with 333 passing Cargo tests across the contract
