...
> Tried the Confidential Tokens preview 👀 and really like that it's a **wrapper**
...
> counterparties* (the payment graph), which is the remittance threat model. Funny thing: we
...
- **Where Tukar differs (factual):** privacy-pool tier, which hides counterparties too;
